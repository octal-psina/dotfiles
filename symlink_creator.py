...
config = [ 'i3', 'user-dirs.dirs', 'i3status', 'gtk-3.0', 'dunst', 'kitty', 'picom', 'starship.toml',  'sublime-text', 'QtProject.conf', 'btop',  'xpad', 'fastfetch', 'test']
...
def file_gather(usr,*args,):
    ...
    for arg in args:
        ...
        for dir in arg:
            ...
            os.mkdir('/home/{usr}/dotfiles/{0}/'.format(dir))
